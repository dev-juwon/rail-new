<header class="header">
    <a href="<?php echo e(route('home')); ?>"><img class="logo" src="images/IMG-20221209-WA0000.jpg" alt="logo"></a>
    <img id="menu" class="menu" src="/images/Hamburger Menu.png" alt="Menu">
</header>

<header class="desktop-header-section">
    <a href="<?php echo e(route('home')); ?>"><img class="logo1" src="images/IMG-20221209-WA0000.jpg" alt="logo"></a>
    ...
    <div class="sidebar1">
        ...
        <div class="side-content container">
           <ul class="menu-content1">
            ...
            <li><a class="pro-arrow" href="<?php echo e(route('products.index')); ?>">Products <img class="menu-arrow1" src="images/Arrow 2.png" alt=""></a>
...
</header><?php /**PATH C:\xampp\aff\resources\views/layouts/_header.blade.php ENDPATH**/ ?>